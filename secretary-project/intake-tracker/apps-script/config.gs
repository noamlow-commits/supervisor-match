...
// זוגות "משבצת סימון ← תאריך" (בקשת טל): סימון ה-✓ ממלא אוטומטית את התאריך הצמוד
// בתאריך היום — אך ורק אם הוא ריק. תאריך שהוזן ידנית לעולם לא נדרס, וניתן לשנותו תמיד.
// אלו כל זוגות ה-bool↔date שקיימים בסכמה. (תאריכים ללא ✓ — כמו "תאריך ראיון" — נשארים ידניים.)
var AUTO_DATE_PAIRS = {
  materialSent: 'materialDate',
  payReg:       'payRegDate',
  payDeposit:   'payDepositDate'
};
